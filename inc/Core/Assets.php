...
use WriteFlowAI\Framework\AssetLoaderTrait;
...
final class Assets implements Registrable {
	 ...
	 */
	private const PREFIX = 'writeflow-ai-';
	...
	public function __construct() {
		$this->plugin_dir = (string) WRITEFLOW_AI_PATH;
		$this->plugin_url = (string) WRITEFLOW_AI_URL;
