...
namespace WriteFlowAI\Core;

use WriteFlowAI\Framework\Contracts\Traits\Singleton;
use WriteFlowAI\Framework\TemplateLoaderTrait;
...
final class Templates {
	 ...
	 */
	private const HOOK_PREFIX = 'writeflow_ai';
	 ...
	 */
	private const TEMPLATE_THEME_DIR = 'writeflow-ai';
	...
	protected function __construct() {
		...
		$this->template_dir       = WRITEFLOW_AI_PATH . self::TEMPLATE_DIR;
	}
