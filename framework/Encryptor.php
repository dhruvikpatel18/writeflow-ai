...
final class Encryptor {
	 ...
	 *
	 * Uses WRITEFLOW_AI_ENCRYPTION_KEY if defined, otherwise falls back to LOGGED_IN_KEY.
	 */
	private static function get_encryption_key(): string {
		if ( defined( 'WRITEFLOW_AI_ENCRYPTION_KEY' ) && '' !== WRITEFLOW_AI_ENCRYPTION_KEY ) {
			return WRITEFLOW_AI_ENCRYPTION_KEY;
		}
